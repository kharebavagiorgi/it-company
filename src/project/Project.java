...
public abstract class Project implements Reportable {
    ...
    public Project(String projectName, BigDecimal budget, LocalDateTime startDate, int teamSize) {
    ...
    public final void getProjectDetails() {
        System.out.println("Project: " + projectName + ", Budget: " + budget + ", Start Date: " + startDate);
    }

    @Override
    public void generateReport() {
        System.out.println("Generating general report for project: " + projectName);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(projectName, budget, startDate, teamSize);
    }
